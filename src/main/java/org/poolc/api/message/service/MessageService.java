...
public class MessageService {
    ...
    public Message findMessageById(Member member, Long messageId) {
        ...
        conversationService.checkWhetherInvolved(message.getConversationId(), member.getLoginID());
        return message;
    }
    ...
    public List<Message> findMessagesByConversationId(Member member, String conversationId) {
        ...
        conversationService.checkWhetherInvolved(conversationId, member.getLoginID());
    ...
    public void deleteMessageBySender(Member member, Long messageId) {
        ...
        conversationService.checkWhetherInvolved(message.getConversationId(), member.getLoginID());
        conversationService.findWhetherSenderOrReceiver(message.getConversationId(), member.getLoginID());
