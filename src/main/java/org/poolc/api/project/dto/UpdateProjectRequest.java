...
public class UpdateProjectRequest {
    ...
    @JsonCreator
    public UpdateProjectRequest(String name, String description, String genre, LocalDate startDate, LocalDate endDate, String thumbnailURL, String body, List<String> memberLoginIDs) {
        this.name = name;
