...
@Getter
public class QuestionPostCreateValues {
    ...
    private final PostType postType = PostType.QUESTION_POST;

    public QuestionPostCreateValues(Board board, Member member, PostCreateRequest postCreateRequest) {
        this.board = board;
        this.member = member;
